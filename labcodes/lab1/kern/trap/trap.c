...
void switch2user(struct trapframe *tf)
{
  ...
  // 0x202 | 0x3000 = 00110010 00000010
  // 0010 00000010 | 00110000 00000000 = 00110010 00000010
  tf->tf_eflags |= 0x3000;
...
static void trap_dispatch(struct trapframe *tf)
{
  ...
  case IRQ_OFFSET + IRQ_TIMER:
     ...
     * variable (increase it), such as ticks in kern/driver/clock.c (2) Every
     * TICK_NUM cycle, you can print some info using a funciton, such as
