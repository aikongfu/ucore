 ...
 *  Concurrent Pascal language. Generally, a monitor is a language construct and the compiler usually 
 *  enforces mutual exclusion. Compare this with semaphores, which are usually an OS construct.
 ...
 *   If a condition variable is signaled with nobody waiting, the signal is lost. Compare this with semaphores, 
 *  in which a signal will allow a process that executes a wait in the future to no block.
